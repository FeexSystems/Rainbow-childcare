    ...
    try {
      ...
      if (error) {
        toast({
          ...
          description: error.message || "Unable to book a visit right now.",
          variant: "destructive",
        });
        return;
      }
        ...
        >
          <div className="p-12">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Thank you for your interest. We'll confirm your visit time by
              email.
            </p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600">
            Come see our facilities and meet the team. Choose your preferred
            location and time.
          </p>
        </div>
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="hillcrest">
                            Hillcrest Rising Stars
                          </SelectItem>
                          <SelectItem value="rainbow_stars">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(v) => update("child_age_group", v)}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          ...
                          <SelectItem value="day-nursery">
                            Day Nursery (3–5)
                          </SelectItem>
                          <SelectItem value="afterschool">
                            Afterschool (5+)
                          </SelectItem>
                        </SelectContent>
                      </Select>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          update("attendees", Number(e.target.value))
                        }
                      />
                    </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(v) => update("consent_contact", v)}
                    />
                    <Label htmlFor="consent" className="text-sm">
                      I consent to be contacted about my booking *
                    </Label>
                  </div>
              ...
              <CardContent className="space-y-4 text-sm text-gray-700">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div>
                      Clockhouse Community Association, Coulsdon, CR5 2PT
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-2">
